  ...
  return (
    <section className="relative flex min-h-[90vh] items-center overflow-hidden">
      ...
      <div className="container relative z-10 py-20">
        <p className="mb-3 text-sm font-semibold uppercase tracking-widest text-primary">Sempre Gelado</p>
        <h1 className="font-display text-5xl font-extrabold leading-tight md:text-7xl">
          Sua sede não<br />
          <span className="text-gradient-frost">pode esperar.</span>
        </h1>
        ...
        <Link
          to="/produtos"
          className="mt-8 inline-flex items-center gap-2 rounded-lg bg-gradient-frost px-6 py-3 font-semibold text-primary-foreground transition-transform hover:scale-105"
        >
